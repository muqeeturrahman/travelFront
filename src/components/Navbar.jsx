...
function Navbar() {
  ...
  return (
    <>
      {/* Top Contact Bar */}
      <div className="bg-gray-900 text-gray-100 text-xs sm:text-sm py-2 border-b border-gray-800">
        <div className="container mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <div className="flex flex-wrap items-center gap-4">
            <span className="flex items-center gap-1">
              <svg className="w-4 h-4 inline-block" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M3 5a2 2 0 012-2h2.28a2 2 0 011.7 1l.94 1.88a2 2 0 001.7 1H19a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V5z" /></svg>
              <a href="mailto:Info@flightonbudget.com" className="hover:text-blue-400">Info@flightonbudget.com</a>
            </span>
            <span className="flex items-center gap-1">
              <svg className="w-4 h-4 inline-block" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M3 5a2 2 0 012-2h2.28a2 2 0 011.7 1l.94 1.88a2 2 0 001.7 1H19a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V5z" /></svg>
              <a href="tel:+18888548426" className="hover:text-blue-400">+1 888 854 8426</a>
            </span>
            <span className="flex items-center gap-1">
              <svg className="w-4 h-4 inline-block" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M17 20h5v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2h5" /></svg>
              <span>1 Clarence St, Strathfield NSW 2135, Australia</span>
            </span>
          </div>
